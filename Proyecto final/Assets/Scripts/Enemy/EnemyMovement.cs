...
public class EnemyMovement : MonoBehaviour
{
    ...
    [SerializeField] enum EnemyType { Stalker, Rioter, Hunter }; //para tener un menu de seleccion con nombres y no numeros u otras ref inconcretas
