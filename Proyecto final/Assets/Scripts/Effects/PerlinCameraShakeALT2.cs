...
public class PerlinCameraShakeALT2 : MonoBehaviour
{
    //[SerializeField]
    ...
    [SerializeField]
    [Tooltip("El incremento de la variable anterior a lo largo del tiempo")]
    [Range(0, 10)]
    private float _translationMasterMagIncrease = 0.01f;
    ...
    [SerializeField][Range(0f, 1f)] float addedTrauma = 0.5f;
    ...
    private void Start()
    {
        ...
        //EVENTOS
        DreamManager.OphanimShake += OnNewTrauma;
        DreamManager.ShakeRestartMag += ShakeRestartMag;
    }

    void ShakeRestartMag()
    {
        _translationMasterMagnitude = 1f;
    }
    ...
    private void OnNewTrauma()
    {
        _translationMasterMagnitude += _translationMasterMagIncrease;
        _trauma = Mathf.Clamp01(addedTrauma);
